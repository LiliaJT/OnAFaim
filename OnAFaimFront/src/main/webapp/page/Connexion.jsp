...
<div id="content" class="row">
	<div class="col-12">
		...
		<div id="menuConnect">
			<form method="post" action="../connexion" class="px-4 py-3">
				<div class="form-group">
					<input type="hidden" name="action" value="connect">
					<label for="exampleDropdownFormEmail1">email</label>
					<input type="email" name="email" class="form-control" id="exampleDropdownFormEmail1" placeholder="Saisir votre nom">
				</div>
				<div class="form-group">
					<label for="exampleDropdownFormPassword1">Password</label>
					<input type="password" name="pass" class="form-control" id="exampleDropdownFormPassword1" placeholder="Saisir votre password">
				</div>
